        ...
        <div id='smallboy'>
          ...
          <div id='signup'>
            ...
            <form onSubmit={(event) => this.handleSignUp(event)}>
              <div className='input-field'>
                            First name: <input name='firstname' type='text' required defaultValue='a' />
              </div>
              <div className='input-field'>
                            Family name: <input name='familyname' type='text' required defaultValue='a' />
              </div>
              <div className='input-field'>
                            Gender:
                <select name='gender'>
              ...
              <div className='input-field'>
                            City: <input name='city' type='text' required defaultValue='a' />
              </div>
              <div className='input-field'>
                            Country: <input name='country' type='text' required defaultValue='a' />
              </div>
              <div className='input-field'>
                            Email: <input name='email' type='email' required defaultValue='a@a' />
              </div>
              <div className='input-field'>
                            Password: <input type='password' name='password' required minLength='8' defaultValue='aaaaaaaa' />
              </div>
              <div className='input-field'>
